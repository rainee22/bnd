        ...
        <div class="container-lg">
            <div class="row gy-4 row-cols-1 row-cols-sm-2 row-cols-md-3">
               ...
               <div class="col">
                  ...
                  <img src="{{ asset('images/img7.png') }}" style="background-color: #ffffff; padding: 15px; width: 100%; box-shadow: 0 0 15px rgba(0,0,0,0.3); cursor: pointer;" title="Gas Monitoring System    "></button>
               </div>
